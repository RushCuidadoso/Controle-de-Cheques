...
class menuApp(QtWidgets.QMainWindow, frmmenu.Ui_frmmenu):
    ...
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        self.btnabrircheque.pressed.connect(self.abrircheque)
        self.btnabrirparametros.pressed.connect(self.abrirparametros)
    ...
    def closeEvent(self, evnt):
        ...
        os.system(r'if not exist "C:\BackupCheque\" mkdir C:\BackupCheque')
        direccion = r'-f C:\BackupCheque\BackupCheque.dump controlcheque'
    ...
    def abrircheque(self):
        from coderegistro import registroApp
        self.setEnabled(False)
        registro = registroApp(parent=self)
        registro.abrir(self)
        registro.show()

    def abrirparametros(self):
        from codeparametros import parametrosApp
        self.setEnabled(False)
        self.parametros = parametrosApp(parent=self)
        self.parametros.show()
        self.parametros.iniciar(self)
